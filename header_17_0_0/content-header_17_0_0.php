            ...
            <div class="container">
                ...
                <div class="header_17_0_0_box_1__Infor">
                    <div class="header_17_0_0_box_1__date">
                        <i class=" icon-calendar"></i> <b> Thứ Hai - Chủ Nhật</b> 08h - 20h
                    </div>
                    <div class="header_17_0_0_box_1__place">
                        <a href="#"><i class=" icon-location-2"></i><b>Hà Nội</b></a>
                        <ul>
                            <li>
                                <a href="#"><i class=" icon-location-2"></i><b>Hải Phòng</b></a>
                            </li>
                            <li>
                                <a href="#"><i class=" icon-location-2"></i><b>Nghệ An</b></a>
                            </li>
                            <li>
                                <a href="#"><i class=" icon-location-2"></i><b>Đà Nẵng</b></a>
                            </li>
                            <li>
                                <a href="#"><i class=" icon-location-2"></i><b>Bình Dương</b></a>
                            </li>
                            <li>
                                <a href="#"><i class=" icon-location-2"></i><b>TP.HCM</b></a>
                            </li>
                            <li>
                                <a href="#"><i class=" icon-location-2"></i><b>Cần Thơ</b></a>
                            </li>
                        </ul>
                    </div>
                    <a href="" class="header_17_0_0_box_1__call"><i></i><b>Tổng đài</b> 1900.6499</a>
                </div>
